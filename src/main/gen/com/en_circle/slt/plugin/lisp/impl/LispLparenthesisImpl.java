...
public class LispLparenthesisImpl extends ASTWrapperPsiElement implements LispLparenthesis {

  public LispLparenthesisImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LispVisitor visitor) {
    visitor.visitLparenthesis(this);
  }
